...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Stratix II" ENABLE_RUNTIME_MOD="NO" INIT_FILE="ram.hex" NUMWORDS_A=128 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" WIDTH_A=4 WIDTH_BYTEENA_A=1 WIDTHAD_A=7 address_a clock0 data_a q_a wren_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.mem_init0 = 128'h00000000000000000000000000000055,
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 128'h00000000000000000000000000000066,
	...
	defparam
		...
		ram_block1a_2.mem_init0 = 128'h00000000000000000000000000000078,
...
endmodule //lpm_ram_dq1_altsyncram
//VALID FILE
...
`endif
	...
	lpm_ram_dq1_altsyncram	lpm_ram_dq1_altsyncram_component (
				.wren_a (wren),
				.clock0 (clock),
				.address_a (address),
				.data_a (data),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq1.tdf TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq1_inst.tdf TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq1_syn.v TRUE
